...
// kế thừa class SliderModel
	...
	public function index()
	{
		...
		$this->loadView("SliderView.php",["data"=>$data,"numPage"=>$numPage]);
	}
	...
	public function update()
	{
		...
		//gọi view, truyền dữ liệu ra view
		$this->loadView("SliderFormView.php",["record"=>$record,"action"=>$action]);
	}
	...
	public function create()
	{
		...
		$this->loadView("SliderFormView.php",["action"=>$action]);
	}
