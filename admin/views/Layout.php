...
<html lang="en">
  <head>
    <!-- <base href="http://hermer.byethost7.com/admin/"> -->
    <base href="http://localhost/Hermer/admin/">
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../assets/admin/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="../assets/admin/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="../assets/admin/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="../assets/admin/dist/css/adminlte.min.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="../assets/admin/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="../assets/admin/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet" href="../assets/admin/summernote/summernote-bs4.min.css">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #75859b;">
        <!-- Brand Logo -->
        <a href="home.html" class="brand-link">
          ...
          <span class="brand-text font-weight-light">ĐỨC PHÚC 368</span>
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              ...
              <img style="width: 40px;height: 40px;" src="../assets/upload/users/<?php echo $_SESSION['photo']; ?>" class="img-circle elevation-2" alt="User Image">
              
            </div>
            <div class="info">
              <a href="#" class="d-block">Xin Chào : <?php
                echo $_SESSION['name'];
              ?></a>
            </div>
          </div>
          ...
          <nav class="mt-2">
            ...
            <li class="nav-item">
              <a href="contact.html" class="nav-link">
                ...
                $count = $conn->prepare("select * from contact where readed = '0'");
                $count->execute();
                $soluong = $count->rowCount();
                ?>
                <p>
                  Danh sách liên hệ ( <strong style="color:red;"><?php echo $soluong; ?></strong> )
                </p>
              </a>
            </li>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          ...
          <!-- Sparkline -->
          <script src="../assets/admin/sparklines/sparkline.js"></script>
          <!-- JQVMap -->
          <script src="../assets/admin/jqvmap/jquery.vmap.min.js"></script>
          <script src="../assets/admin/jqvmap/maps/jquery.vmap.usa.js"></script>
          <!-- jQuery Knob Chart -->
          <script src="../assets/admin/jquery-knob/jquery.knob.min.js"></script>
          <!-- daterangepicker -->
          <script src="../assets/admin/moment/moment.min.js"></script>
          <script src="../assets/admin/daterangepicker/daterangepicker.js"></script>
          <!-- Tempusdominus Bootstrap 4 -->
          <script src="../assets/admin/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
          <!-- Summernote -->
          <script src="../assets/admin/summernote/summernote-bs4.min.js"></script>
          <!-- overlayScrollbars -->
          <script src="../assets/admin/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
          <!-- AdminLTE App -->
