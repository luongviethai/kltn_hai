	...
	trait CartModel{		
		...
		public function cartCheckOut(){
			...
			header("location:checkout.html");
			  Connection::sendMail1($_SESSION['customer_name'],$_SESSION['customer_email'],$_SESSION['sdt'],$_SESSION['address'],$tongtien);
		}
		//=============
