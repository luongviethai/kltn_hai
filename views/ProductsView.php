...
<div class="body">
    ...
    <div class="body-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Toàn bộ sản phẩm</li>
                            ...
                            <div class="product-img1">
                                ...
                                <div class="product-hot-title">
                                    ...
                                    <div class="gia">
                                        ...
                                        <div class="price-before1" style="color: white;text-decoration: line-through;font-size: 12px;">
        ...
        <div class="right">
            ...
            <div class="top-right">
                <div class="top-list-product">
                    <?php
                    $sosp = $this->modelTotalRecordAllProducts();
                    ?>
                    ...
                    <div style="margin-top: 15px;margin-left: 600px;position: absolute;z-index: 1;" class="col-md-2 text-right">
                        ...
                        ?>
                        <select class="form-control" onchange="location.href = 'allproducts-sort-order='+this.value+'.html';">
                    ...
                    <div class="container">
                        ...
                        <?php if (($this->modelTotalRecordAllProducts()) != 0): ?>
                        ...
                        <?php elseif(($this->modelTotalRecordAllProducts()) == 0): ?>
                        <div style="text-align: center;font-size: 16px;font-family: 'Quicksand', sans-serif;color: white;">Chưa có sản phẩm</div>
                        <?php endif ?>
                            ...
                            <div class="panel-body">
                                <div class="pull-right">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <?php if($page == $i): ?>
                                            <a style="background:#6c757d;color: white;" class="page-link" href="allproducts/page=<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php elseif($page != $i): ?>
                                            <a class="page-link" href="allproducts/page=<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php endif ?>
                                        </li>
                                        <?php endfor; ?>
                                    </ul>
