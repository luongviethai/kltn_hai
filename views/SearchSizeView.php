...
<div class="body">
    ...
    <div class="body-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tìm kiếm theo màu xắc : <?php echo ucfirst($key); ?></li>
            ...
            <div style="height: 150px;" class="item_search-box3">
                ...
                <div class="color" style="margin-top:15px;">
                    <ul>
                        ...
                        <?php if ($key=="60x60cm"): ?>
                        <li>
                            <a style="background: #ba933e;
                            color: white;" href="search/size=60x60cm.html">60x60cm</a>
                        </li>
                        <?php
                        elseif($key!="60x60cm"):
                        ?>
                        ...
                        <li>
                            <a style="background: #ba933e;
                            color: white;" href="search/size=80x80cm.html">80x80cm</a>
                        </li>
                        <?php
                        elseif($key!="80x80cm"):
                        ?>
                        ...
                        <?php endif ?>
                        <?php if ($key=="100x100cm"): ?>
                        <li>
                            <a style="background: #ba933e;
                            color: white;" href="search/size=100x100cm.html">100x100cm</a>
                        </li>
                        <?php
                        elseif($key!="100x100cm"):
                        ?>
                        <li>
        ...
        <div class="right">
            ...
            <div class="top-right">
                <div class="top-list-product">
                    <?php
                    $sosp = $this->modelTotalRecordSearchSize();
                    ?>
                    <div class="title-list-product">
                        <h2>Kích cỡ : <?php echo ucfirst($key); ?></h2>
                    ...
                    <div style="margin-top: 15px;margin-left: 600px;position: absolute;z-index: 1;" class="col-md-2 text-right">
                        ...
                        ?>
                        <select class="form-control" onchange="location.href = 'size-sort-order/size=<?php echo $key; ?>-'+this.value+'.html';">
                    ...
                    <div class="container">
                        ...
                        <?php if (($this->modelTotalRecordSearchSize()) != 0): ?>
                        ...
                        <?php
                        elseif(($this->modelTotalRecordSearchSize()) == 0):
                        ?>
                        <div style="text-align: center;font-size: 16px;font-family: 'Quicksand', sans-serif;color: white;">Không tìm thấy sản phẩm với kích cỡ tương ứng</div>
                        <?php
                        endif;
                        ?>
                    </div>
                            ...
                            <div class="panel-body">
                                <div class="pull-right">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <?php if($page == $i): ?>
                                            <a style="background:#6c757d;color: white;" class="page-link" href="size/page=<?php echo $key; ?>-<?php echo $i; ?>"><?php echo $i; ?></a>
                                            <?php elseif($page != $i): ?>
                                            <a class="page-link" href="size/page=<?php echo $key; ?>-<?php echo $i; ?>"><?php echo $i; ?></a>
                                            <?php endif ?>
                                        </li>
                                        <?php endfor; ?>
                                    </ul>
