            ...
            <div class="top-right">
                <div class="top-list-product">
                    ...
                    <div style="margin-top: 15px;margin-left: 600px;position: absolute;z-index: 1;" class="col-md-2 text-right">
                        ...
                        ?>
                        <select class="form-control" onchange="location.href = 'subcategory-sort-order=<?php echo $id; ?>-'+this.value+'.html';">
                            ...
                            <div class="panel-body">
                                <div class="pull-right">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <?php if($page == $i): ?>
                                            <a style="background:#6c757d;color: white;" class="page-link" href="subcategory/page=<?php echo $id; ?>-<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php elseif($page != $i): ?>
                                            <a class="page-link" href="subcategory/page=<?php echo $id; ?>-<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php endif ?>
                                        </li>
                                        <?php endfor; ?>
                                    </ul>
