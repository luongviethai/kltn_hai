...
<div class="body">
    ...
    <div class="body-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tìm kiếm theo giá : <?php echo number_format($fromPrice); ?> ₫ - <?php echo number_format($toPrice); ?> ₫</li>
    ...
    <div class="main">
        <div class="left">
            ...
            <div style="height: 170px;" class="item_search-box2">
                ...
                <div class="checkbox">
                    <input <?php if ($fromPrice == 0 && $toPrice == 200000): ?>
                    checked
                    <?php endif ?> onclick="location.href='search/fromPrice=0&toPrice=200000.html'" class="" type="checkbox" id="1" name="1" value="">
                    <label for="1">Dưới 200,000 VNĐ</label><br>
                    <input <?php if ($fromPrice == 200000 && $toPrice == 300000): ?>
                    checked
                    <?php endif ?> onclick="location.href='search/fromPrice=200000&toPrice=300000.html'" type="checkbox" id="2" name="2" value="">
                    <label for="2">200,000 - 300,000 VNĐ</label><br>
                    <input <?php if ($fromPrice == 300000 && $toPrice == 400000): ?>
                    checked
                    <?php endif ?> onclick="location.href='search/fromPrice=300000&toPrice=400000.html'" type="checkbox" id="3" name="3" value="">
                    <label for="3">300,000 - 400,000 VNĐ</label><br>
                    <input <?php if ($fromPrice == 500000 && $toPrice == 1000000): ?>
                    checked
                    <?php endif ?> onclick="location.href='search/fromPrice=500000&toPrice=1000000.html'" type="checkbox" id="4" name="3" value="">
            ...
            <div style="height: 150px;" class="item_search-box3">
                ...
                <div class="color" style="margin-top:15px;">
                    <ul>
                        <li>
                            <a href="search/size=60x60cm.html">60x60cm</a>
                        </li>
                        <li>
                            <a href="search/size=80x80cm.html">80x80cm</a>
                        </li>
                        <li>
                            <a href="search/size=100x100cm.html">100x100cm</a>
                        </li>
        ...
        <div class="right">
            ...
            <div class="top-right">
                <div class="top-list-product">
                    <?php
                    $sosp = $this->modelTotalRecordSearchPrice();
                    ?>
                    <div class="title-list-product">
                        <h2>Khoảng giá : <?php
                        echo number_format($fromPrice);
                        ?> ₫ - <?php echo number_format($toPrice) ; ?> ₫</h2>
                    ...
                    <div style="margin-top: 15px;margin-left: 600px;position: absolute;z-index: 1;" class="col-md-2 text-right">
                        ...
                        ?>
                        <select class="form-control" onchange="location.href = 'price-sort-order/fromPrice=<?php echo $fromPrice; ?>-toPrice=<?php echo $toPrice; ?>-'+this.value+'.html';">
                    ...
                    <div class="container">
                        ...
                        <?php if (($this->modelTotalRecordSearchPrice()) != 0): ?>
                        <div id="products" class="row view-group">
                            <?php foreach ($data as $rows): ?>
                            <div class="item col-xs-4 col-lg-4">
                                <div class="thumbnail card list-product-content" style="position: relative;">
                                    ...
                                    <?php endif ?>
                                    <div style="height: 350px;" class="img-event product-img">
                        ...
                        <?php
                        elseif(($this->modelTotalRecordSearchPrice()) == 0):
                        ?>
                        <div style="text-align: center;font-size: 16px;font-family: 'Quicksand', sans-serif;color: white;">Không tìm thấy sản phẩm tương ứng</div>
                        <?php
                        endif;
                        ?>
                    </div>
                            ...
                            <div class="panel-body">
                                <div class="pull-right">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item"><a class="page-link" href="price/fromPrice=<?php echo $fromPrice; ?>-toPrice=<?php echo $toPrice; ?>-page=<?php
                                        echo $i; ?>.html"><?php echo $i; ?></a></li>
                                        <?php endfor; ?>
                                    </ul>
                                </div>
                            </div>
