        ...
        <div class="right">
            ...
            <div class="top-right">
                <div class="top-list-product">
                    <?php
                    $sosp = $this->modelTotalRecordAllCategoryProducts();
                    ?>
                    ...
                    <div style="margin-top: 15px;margin-left: 600px;position: absolute;z-index: 1;" class="col-md-2 text-right">
                        ...
                        ?>
                        <select class="form-control" onchange="location.href = 'category-sort-order=<?php echo $id; ?>-'+this.value+'.html';">
                    ...
                    <div class="container">
                        ...
                        <?php if (($this->modelTotalRecordAllCategoryProducts()) != 0): ?>
                        ...
                        <?php
                        elseif (($this->modelTotalRecordAllCategoryProducts()) == 0):
                        ?>
                            ...
                            <div class="panel-body">
                                <div class="pull-right">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <?php if($page == $i): ?>
                                            <a style="background:#6c757d;color: white;" class="page-link" href="category/page=<?php echo $id; ?>-<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php elseif($page != $i): ?>
                                            <a class="page-link" href="category/page=<?php echo $id; ?>-<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php endif ?>
                                        </li>
                                        <?php endfor; ?>
                                    </ul>
                    ...
                    <?php elseif(($this->modelTotalRecordAllCategoryProducts()) == 0): ?>
