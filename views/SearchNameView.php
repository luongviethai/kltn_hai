...
<div class="body">
    ...
    <div class="body-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tìm kiếm : <?php echo $key; ?></li>
            ...
            <div class="top-right">
                <div class="top-list-product">
                    ...
                    <div style="margin-top: 15px;margin-left: 600px;position: absolute;z-index: 1;" class="col-md-2 text-right">
                        ...
                        ?>
                        <select class="form-control" onchange="location.href = 'name-sort-order=<?php echo $key; ?>-'+this.value+'.html';">
                    ...
                    <div class="container">
                        ...
                        <?php if (($this->modelTotalRecord()) != 0): ?>
                        ...
                        <?php
                        elseif (($this->modelTotalRecord()) == 0):
                        
                        ?>
                        <div style="text-align: center;font-size: 16px;font-family: 'Quicksand', sans-serif;color: white;">Không tìm thấy sản phẩm với từ khóa : <?php echo $key; ?></div>
                        <?php
                        endif;
                        ?>
                    </div>
                            ...
                            <div class="panel-body">
                                <div class="pull-right">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <?php if($page == $i): ?>
                                            <a style="background:#6c757d;color: white;" class="page-link" href="name/page=<?php echo $key; ?>-<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php elseif($page != $i): ?>
                                            <a class="page-link" href="name/page=<?php echo $key; ?>-<?php echo $i; ?>.html"><?php echo $i; ?></a>
                                            <?php endif ?>
                                        </li>
                                        <?php endfor; ?>
                                    </ul>
                    ...
                    <?php elseif(($this->modelTotalRecord()) == 0): ?>
